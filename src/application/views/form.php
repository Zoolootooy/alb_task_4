...
<script type="module" src="public/vue/form.js"></script>
...
<div class="container">
    <div class="row">
        <div class="col-12 mb-5" id="app">
            ...
            <form v-if="seen1" id="first" name="first" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-12 form-group mb-4">
                        ...
                        <select id="country_id"
                          ...
                          <option v-for="country in countriesList" v-bind:value="country.id">{{ country.name}}
                          </option>
                        </select>
            ...
            <form v-if="seen2" id="second" name="second" method="post" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-12 ">
